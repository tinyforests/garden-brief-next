...
export default function Page() {
  ...
  // Netlify Forms: POST to static file at /__forms.html (ensure public/__forms.html exists)
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        <header className="flex items-start justify-between gap-4 sm:items-center">
          <div className="text-white">
            <h1 className="font-heading text-2xl font-normal tracking-tight sm:text-4xl">
